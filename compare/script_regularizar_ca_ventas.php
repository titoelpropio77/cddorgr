...
function gestionar_descuentos_incrementos_cdd() {
...
function gestionar_descuentos_incrementos_demazu() {
...
function gestionar_descuentos_incrementos_vexsa() {
...
function gestionar_descuentos_incrementos_demas() {
    $sql = "select * from venta_pago inner join venta on(vpag_ven_id=ven_id) 
        ...
        and (ven_numero is null or ven_numero = '') and ven_estado != 'Anulado'";
    $pagos = FUNCIONES::objetos_bd_sql($sql);
...
if ($_GET[tarea] == 'desc_inc_cdd') {
    gestionar_descuentos_incrementos_cdd();
}

if ($_GET[tarea] == 'desc_inc_demazu') {
    gestionar_descuentos_incrementos_demazu();
}

if ($_GET[tarea] == 'desc_inc_vexsa') {
    gestionar_descuentos_incrementos_vexsa();
}

if ($_GET[tarea] == 'desc_inc_demas') {
    gestionar_descuentos_incrementos_demas();
}

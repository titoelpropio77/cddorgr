...
//        echo "historial";
        ...
        $fr = '';
        $vista = '';
        if ($_POST[forma_reporte] == 'resumido') {
            $fr = 'historial';
            $vista = 'historial';
        } else {
            $fr = 'detallado';
            $vista = 'miscomisiones_detallado';
        }
        
//        $resp = SISTEMA::send_post(_servicio_url . "gestor.php?mod=comisiones&tarea=historial&token=" . $this->Usuario->get_token(), $data); 
        $resp = SISTEMA::send_post(_servicio_url . "gestor.php?mod=comisiones&tarea=".$fr."&token=" . $this->Usuario->get_token(), $data); 

...
<!--                        <h4>Linea 2</h4>-->
                        <table id="tablaResumen3" class="footable table dataTable table-bordered table-hover tableSinpaginar" >
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="3" class="alineado_derecho" ><b>Total:</b></td>
...
//        });
    ...
    $('#tablaResumen1,#tablaResumen2,#tablaResumen3,#tablaResumen4,#tablaResumen5,#tablaResumen6,#tablaResumen7').dataTable({paging: true});

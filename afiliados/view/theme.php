                ...
                <div class="mobile-menu">
                    ...
                    <div class="collapse mobile-navbar" id="mobile-collapse">
                        <ul class="nav navbar-nav">
                            <li> 
                                <a class="" href="<?php echo _base_url; ?>contrasena">Mi Perfil</a>
                            </li> 
                            <li>
                ...
                <ul class="nav" id="side-menu"> 
                    ...
                    <li class="<?php echo $_GET[uri1] == 'mired' ? "active" : " "; ?>">
                        ...
                        <ul style="" aria-expanded="true" class="nav nav-second-level collapse <?php echo $_GET[uri1] == 'mired' ? "in" : " "; ?>">
                            ...
                            <li class="<?php echo $_GET[uri2] == 'datos-linea' ? "active" : " "; ?>"><a href="<?php echo _base_url; ?>mired/datos-linea">Datos Red Afiliados</a></li>                                    
                        </ul>
                    </li>
                    ...
                    <li class="<?php echo $_GET[uri1] == 'contrasena' ? "active" : ""; ?>">                        
                        <a href="<?php echo _base_url; ?>contrasena"> <span class="nav-label">Mi Perfil</span></a>
                    </li>
                </ul>
            </div> 
        </aside>

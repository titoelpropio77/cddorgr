        ...
        <div class="hpanel">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane active">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="tablaPend" class="footable table dataTable table-bordered table-hover tableSinpaginar" >
                                <thead>
                                    <tr>
                                        <th>Nro</th> 
                ...
                <div id="tab-2" class="tab-pane">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="tablaHab" class="footable table dataTable table-bordered table-hover tableSinpaginar" >
                                <thead>
                                    <tr>
                                        <th>Nro</th> 
                                        <th data-hide="phone,tablet">Fecha</th>
                ...
                <div id="tab-4" class="tab-pane">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="tablaConc" class="footable table dataTable table-bordered table-hover tableSinpaginar" >
                                <thead>
                                    <tr>
                                        <th>Nro</th> 
                                        <th data-hide="phone,tablet">Fecha</th>
...
<script>
    ...
    $('#tablaPend,#tablaHab,#tablaDes,#tablaConc,#tablaExp,#tablaDev').dataTable({paging: false});

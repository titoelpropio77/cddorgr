...
class CLIENTES extends BUSQUEDA 
{
	var $formulario;
	var $mensaje;
					...
					<div class="Subtitulo">Datos</div>
						<div id="ContenedorSeleccion">
							...
							<div id="ContenedorDiv">
							   ...
							   <div id="CajaInput">
								  <textarea rows="10" cols="50" name="cli_link" id="cli_link"><?php echo $_POST['cli_link'];?></textarea>									
							   </div>
	...
	{	
		...
		{		    
			...
			{ 
					...
					$mifile='imagenes/contenido/'.$upload_class->file_name;
					...
					if ($handle->uploaded) 
					{
						...
						$handle->process('imagenes/contenido/chica/');

...
//        echo FUNCIONES::atributo_bd_sql("select cue_descripcion as campo from con_cuenta where cue_ges_id='$_SESSION[ges_id]' and cue_codigo='$objeto->urb_cco_codigo'");
    ...
    function insertar_tcp() {
        ...
        $sql = "insert into urbanizacion(urb_nombre,urb_monto_anticipo,urb_interes_anual,urb_val_costo,urb_une_id) values 
                                    ('$_POST[urb_nombre]','$_POST[urb_monto_anticipo]','$_POST[urb_interes_anual]','$_POST[urb_val_costo]','$_POST[urb_une_id]')";
...
//        echo $sql.'<br>';
    ...
    function ver_cuentas(){
        ...
        $_POST['urb_inv_terrenos_adj'] = $objeto->urb_inv_terrenos_adj;
        $_POST['urb_ing_diferido'] = $objeto->urb_ing_diferido;
        
        $_POST['urb_reserva'] = $objeto->urb_reserva;
        $_POST['urb_ing_reserva'] = $objeto->urb_ing_reserva;
        $_POST['urb_ing_cambio_tit'] = $objeto->urb_ing_cambio_tit;
        $_POST['urb_ing_cambio_ubi'] = $objeto->urb_ing_cambio_ubi;
        $_POST['urb_ing_fusion'] = $objeto->urb_ing_fusion;

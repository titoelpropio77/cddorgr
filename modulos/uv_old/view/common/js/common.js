...
serviceCtrl = {
    ...
    ajaxMethod: function (e) {
        ...
        return e = e ? e : "", t = t ? t : "",
                this.ajaxMethod(
                        {
                            data: r,
                            url: this.gatePath + "?c=" + e + "&a=" + t+ "&mapa="+getUrlVars()["mapa"]+ "&u="+getUrlVars()["u"],
                            success: a
                        }
                )
    }
    , ajaxSuccess: function (e, t) {
        ...
        if (4 != e) {
            ...
            for (var a = this.mapsPath + t.map.id + "/map_{z}_{x}_{y}.png", r = t.map.mapImage.width, i = t.map.mapImage.height, n = 0, o = r, s = i, l = 129; o > l || s > l; )

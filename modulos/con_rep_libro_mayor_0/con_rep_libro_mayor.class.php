                ...
                <form id="frm_sentencia" name="frm_sentencia" action="gestor.php?mod=<?php echo $this->modulo; ?>&form=<?php echo $tf;?>" method="POST" enctype="multipart/form-data">  
                    ...
                    <div id="FormSent">
                        ...
                        <div id="ContenedorSeleccion">
                            ...
                            <div id="ContenedorDiv">
                                <div class="Etiqueta" >Filtrar Cuentas por:</div>
                                <div id="CajaInput">                                    
                                    <select name="fcuentas" id="fcuentas">
                                        <option value="">Mostrar todo</option>
                                        <option value="lista">Personalizado</option>
                            ...
                            <div id="fcuenta-lista" class="fcuenta-cont">
                                <div id="ContenedorDiv">
                            ...
                            <div id="fcuenta-titulo" class="fcuenta-cont">
                                <div id="ContenedorDiv">
                                    <div class="Etiqueta" >Titulo de Cuenta</div>
                                    <div id="CajaInput">                                    
                                        <input name="id_tit_cuenta" id="id_tit_cuenta"  type="hidden" >
                                        <input name="nombre_tit_cuenta" id="nombre_tit_cuenta"  type="text" class="caja_texto" value="" size="25">
                                    </div>
                                </div>
                            </div>
                            <div id="fcuenta-rango" class="fcuenta-cont">
                                <div id="ContenedorDiv">
                                    <div class="Etiqueta" >Desde</div>
                                    <div id="CajaInput">
                                        <input name="codigo_ini_cuenta" id="codigo_ini_cuenta"  type="text" class="caja_texto" value="" size="25">
                                    </div>
                                    <div class="Etiqueta" style="min-width: 50px;width: 50px;" >Hasta</div>
                                    <div id="CajaInput">
                                        <input name="codigo_fin_cuenta" id="codigo_fin_cuenta"  type="text" class="caja_texto" value="" size="25">
                                    </div>
                                </div>
                            </div>
                            <script>
                                ...
                                function complete_cuenta_tit(){
                                    var options = {
                                        script: "AjaxRequest.php?peticion=listCuenta&limit=6&tipo=cuenta&gesid="+$("#gestion").val()+"&cu_tipo=t&",
                                        varname: "input",
                                        json: true,
                                        shownoresults: false,
                                        maxresults: 6,
                                        callback: function(obj) {
                                            $("#id_tit_cuenta").val(obj.id);
                                        }
                                    };
                                    var as_json1 = new _bsn.AutoSuggest('nombre_tit_cuenta', options);                                      
                                }
            ...
            function mostrar_reporte() {
                ...
                <div id="contenido_reporte" style="clear:both;">                    
                    ...
                    <center>
                        ...
                        <table style="font-size:12px;" width="100%" cellpadding="5" cellspacing="0" >
                            <tr>
                                ...
                                <td width="20%">
                                    <p align="center" >
                                    <center>
                                        <strong><h3>LIBRO MAYOR</h3></strong></br>
                                        <?php
                                        ...
                                        </br><strong>Expresado ennn: <?php echo $this->descripcion_moneda($_POST['moneda_reporte']); ?></strong>
                                    </center>
                                </p>
                                </td>
                        ...
                        $filtro = "";
                        $fcuentas=$_POST[fcuentas];
                        if($fcuentas=='lista'){
                            $lista_cuentas = $_POST['lista_cuentas'];
                            if ($lista_cuentas) {
                                $filtro = " and $cuenta in($lista_cuentas)";
                            }
                        }elseif($fcuentas=='titulo'){
                            $cuenta_tit=  FUNCIONES::objeto_bd_sql("select * from con_cuenta where cue_id='$_POST[id_tit_cuenta]'");
                            $filtro=" and cue_tree_left>=$cuenta_tit->cue_tree_left and cue_tree_right<=$cuenta_tit->cue_tree_right ";
                        }elseif($fcuentas=='rango'){
                            $cod_ini=$_POST[codigo_ini_cuenta];
                            $cod_fin=$_POST[codigo_fin_cuenta];
                            if($cod_ini){
                                $filtro.=" and cue_codigo>='$cod_ini'";
                            }
                            if($cod_fin){
                                $filtro.=" and cue_codigo<='$cod_fin'";
                            }
                        }

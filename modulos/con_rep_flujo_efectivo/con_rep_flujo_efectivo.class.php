...
//            function mostrar_tabla_resultados($cf_ingresos,$cf_egresos,$monto_res){
                ...
                <table   width="95%"  class="tablaReporte" cellpadding="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($formula_val as $campo){?>
                            ...
                            <?php $tmonto+=($cuenta->tmonto*$campo->op)*$campo->signo;?>
                        <?php } ?>
                        
                        <?php $this->total($tmonto," S A L D O ",$max_level); ?>
                        <?php $this->total($saldo_inicial," S A L D O &nbsp; I N I C I A L ",$max_level); ?>
                        <?php $this->total($tmonto+$saldo_inicial," S A L D O &nbsp; F I N A L ",$max_level); ?>
                    </tbody>
            ...
            function total_debe_haber_cuenta($id_cuenta) {
                ...
                $sql = "
                        ...
                        where
                            c.cmp_id=cd.cde_cmp_id and c.cmp_eliminado='No' and cd.cde_cfl_id=$id_cuenta $filtro $fcentro_c

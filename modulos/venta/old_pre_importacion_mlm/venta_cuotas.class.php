        ...
        if($monto_pagado>0){
            ...
            if($str_mora_ids){
                ...
                if (count($mora_ids) ==  count($cuotas) && count($cuotas)==  count($mora_montos)){
                    ...
                    $this->moraulario->ventana_volver($mensaje, $this->link . '?mod=' . $this->modulo,'','Error');
                    return;
                }
            }
...
//                echo "lllllllllllllllll pppppp<br>";
        ...
        if($exito){
            ...
            $this->formulario->ventana_volver("Anulacion de pago realizado Exitosamente",$url, '', "Correcto");
        }else{                            
            $exito = false;
...
//        }
    ...
    function imprimir_pago($venta,$pago_id){
        $this->barra_opciones($venta,'',true);
        echo '<br><br>';
        $this->formulario->dibujar_tarea();
                    ...
                    <tbody>
                        ...
                        $sql="select *
                                from 
                                    venta_pago
                                where
                                vpag_ven_id=$_GET[id] and vpag_estado='Activo' order by vpag_id asc";
                        ...
                        <?php for ($i = 0; $i < $pagos->get_num_registros(); $i++) {?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($pag->vpag_venta_id==0 && $this->obtener_grupo_id($this->usu->get_id())=="Administradores" && $i==$pagos->get_num_registros()-1 && $pag->vpag_importado=='0'){ ?>

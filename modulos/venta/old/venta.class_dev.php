...
//                    $usuario=  FUNCIONES::objeto_bd_sql("select * from ad_usuario where usu_id='$_SESSION[id]'");
                    ...
                    $sql = "insert into venta(
                                ...
                                ven_valor_producto,ven_descuento_producto,ven_costo_producto,ven_costo_producto_cub
                            ) values (
                                ...
                                '$valor_producto','$descuento_producto','$costo_producto','$costo_prod_cub'
                            )";
//                    echo $sql.'<br>';
...
//                    $monto_total = ($venta->ven_monto + $monto_producto) - ($venta->ven_decuento + $descuento_prod);
                        ...
                        if ($_SESSION[id] == 'admin') {
                            echo "<p style='color:red;'>ven_monto:$venta->ven_monto - monto_producto:$monto_producto - ven_descuento:$venta->ven_decuento - desc_prod:$descuento_prod</p>";
                        }
                                ...
                                ?>
                                    <!--
                                            <tr>
                                                    ...
                                                    <b>NOTA</b>.- El Sr. <?php echo $objeto->int_nombre . ' ' . $objeto->int_apellido; ?> (Cliente) dejo <?php echo $cuota_ini; ?> <?php
                                if ($moneda == "1")
                                    echo "Bolivianos";
                                else
                                    echo "Dolares";

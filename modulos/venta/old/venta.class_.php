    ...
    function dibujar_listado() {
        ...
        $sql = "SELECT 
			ven_monto,ven_id,ven_fecha,ven_tipo,ven_moneda,ven_estado,
                        ...
                        ven_devuelto,ven_dev_destino,ven_multinivel,ven_vdo_id
			FROM 
			venta 
...
//                    $usuario=  FUNCIONES::objeto_bd_sql("select * from ad_usuario where usu_id='$_SESSION[id]'");
                    ...
                    $sql = "insert into venta(
                                ...
                                ven_multinivel,ven_of_id,ven_comision_gen
                            ) values (
                                ...
                                '$_POST[multinivel]','$oferta','$ven_comision_gen'
                            )";
//                    echo $sql.'<br>';
...
//            $nro_cuota_inicio++;
        ...
        function cabecera_venta($venta) {
            ...
            ?>				
                            ...
                            <strong>Moneda: </strong> <?php $moneda = $venta->ven_moneda;
        if ($moneda == "1") echo "Bolivianos";
        else echo "Dolares"; ?> <br>
            <?php
                    ...
                    <table border="0"  width="70%" style="font-size:12px;">
                            ...
                            <!--
                                    <tr>
                                            ...
                                            <b>NOTA</b>.- El Sr. <?php echo $objeto->int_nombre . ' ' . $objeto->int_apellido; ?> (Cliente) dejo <?php echo $cuota_ini; ?> <?php if ($moneda == "1") echo "Bolivianos";
                        else echo "Dolares"; ?>  (importe de la cuota inicial) por el terreno (<?php echo $terreno; ?>). <br/>En caso de no pagar dos cuotas pierde los dep?sitos y el lote sin necesidad de Orden Judicial.</br></br></br></br></br>
                                            </td>
                                    </tr>
                            -->
                                    <?php

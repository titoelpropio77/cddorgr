...
class REP_PAGOS_VENTA extends BUSQUEDA {
    ...
    function obtener_resultados() {
        ...
        if ($_POST['inicio'] <> "") {
            ...
            $info[]=array('label'=>'Fecha Inicio Pagos','valor'=> $_POST['inicio']);
        } 
        if ($_POST['fin'] <> "") {
            $filtro.=" and vpag_fecha_pago <='" . FUNCIONES::get_fecha_mysql($_POST['fin']) . "' ";
            $info[]=array('label'=>'Fecha Fin Pagos','valor'=> $_POST['fin']);
        }
        ...
        $sql = "SELECT 
                    ...
                    vpag_saldo_final,ven_ubicacion,ven_multinivel,ven_numero,ven_fecha
                FROM 
                    venta_pago
...
//        $estados_carteras=$_POST[estados_carteras];
        $head=array('#','Nro Venta','F. Venta','Cliente','Telef.','Direccion','Proyecto','UV','MZ','Lote','Ubicacion',
...
//        $fecha_act=date('Y-m-d');
        ...
        for ($i = 0; $i < $num; $i++) {
            ...
            $fecha_venta =  FUNCIONES::get_fecha_latina($obj->ven_fecha);
...
//            FUNCIONES::print_pre($obj);
            ...
            $result[]=array(
                $nro,$obj->ven_id, $fecha_venta,$cliente,"$obj->int_telefono/$obj->int_celular",$obj->int_direccion,$obj->urb_nombre_corto,$obj->uv_nombre,$obj->man_nro,$obj->lot_nro,$obj->ven_ubicacion,
...
//                    );
        ...
        $data=array(
            ...
            'foot'=>array(
                        ...
                        array(
                                array('texto'=>'Convertido a $us.','attr'=>'colspan="18"'),
...
//                                    $('#cja_cue_id').trigger('chosen:updated');
                            ...
                            <fieldset>
                            <legend>Filtros Para Pagos:</legend>
                                <div id="ContenedorDiv">
                                    <div class="Etiqueta" >Fecha Inicio</div>
                                    <div id="CajaInput">

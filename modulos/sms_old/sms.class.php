...
//        echo "-------<br/>";
        $conec = new ADO();
        $sql = "insert into sms(sms_descripcion,sms_texto,sms_usu_id,sms_criterio) 
                            values ('" . $_POST['sms_descripcion'] . "','" . $_POST['sms_texto'] . "','" . $this->usu->get_id() . "','$_POST[criterio]')";
...
//        $sql_update="update bandeja set ban_contenido='$_POST[sms_texto]' where ban_men_id='$_GET[id]'";

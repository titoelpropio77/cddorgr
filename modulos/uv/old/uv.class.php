...
//            echo "formulario para modificar el precio del lote";
    ...
    function guardar_zona() {
        ...
        $sql = "insert into zona(zon_nombre,zon_precio,zon_urb_id,zon_color,zon_cuota_inicial,zon_moneda) 
        values ('" . $_POST['nombre'] . "','" . $_POST['precio'][0] . "','" . $_GET['id'] . "','" . $_POST['color'] . "','" . $_POST['cuota'] . "','" . $_POST['moneda'] . "')";
    ...
    function listado_de_zonas() {
        ...
        $sql = "select zon_id, zon_nombre,zon_precio,zon_color,zon_cuota_inicial,
        zon_moneda from zona where zon_urb_id='" . $_GET['id'] . "' order by zon_precio desc";

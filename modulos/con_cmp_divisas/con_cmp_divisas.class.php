...
class con_cmp_divisas extends BUSQUEDA {

    var $formulario;
    var $mensaje;
    var $usu;

    function con_cmp_divisas() {  //permisos
        $this->ele_id = 192;
        $this->busqueda();
        ...
        $this->modulo = 'con_cmp_divisas';

        $this->formulario = new FORMULARIO();

        $this->formulario->set_titulo('COMPARACION C/V DIVISAS');
    ...
    function dibujar_listado() {
        $sql = "select * from con_cmp_divisas where 1 ";
        $this->set_sql($sql, '');
        $this->set_opciones();
        $this->dibujar();
    }
    ...
    function cargar_datos() {
        ...
        $sql = "select * from con_cmp_divisas 
    ...
    function formulario_params() {
        ...
        <div id="Contenedor_NuevaSentencia">
            <form id="frm_con_cmp_divisas" name="frm_con_cmp_divisas" action="<?php echo $url; ?>" method="POST" enctype="multipart/form-data">  
...
//                            var marcados=$('.checkdetalle[type=checkbox]:checked"');
    ...
    function emergente() {
        ...
        <script>
            ...
            {
                opener.document.frm_con_cmp_divisas.suc_int_id.value = id;
                opener.document.frm_con_cmp_divisas.suc_nombre_persona.value = valor;
                window.close();
            }
        </script>
        <br><center><form name="form" id="form" method="POST" action="gestor.php?mod=con_cmp_divisas&tarea=AGREGAR&acc=Emergente">
                <table align="center">
                    <tr>
        ...
        ?>
            ...
            function insertar_tcp() {
                ...
                $conec = new ADO();
                $sql = "insert into con_cmp_divisas (suc_nombre,suc_descripcion,suc_eliminado)
            ...
            function modificar_tcp() {
                $conec = new ADO();
                $sql = "update con_cmp_divisas set 
...
////                return;
//                    $conec = new ADO();
//                    $sql = "update con_cmp_divisas set suc_eliminado='si' where suc_id='" . $_POST['suc_id'] . "'";
//                    $conec->ejecutar($sql);

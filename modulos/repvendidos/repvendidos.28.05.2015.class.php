		...
		?>		
			...
			<?php
				...
				if($_POST['ven_man_id']<>"")
					...
					$sql="SELECT 
					ven_id,ven_fecha,ven_hora,ven_superficie,ven_monto,ven_cuota_inicial,ven_meses_plazo,ven_cuotam_aux,ven_moneda,ven_tipo,ven_co_propietario,int_nombre,int_apellido,man_nro,lot_nro,cast(man_nro as SIGNED) as manzano ,cast(lot_nro as SIGNED) as lote,lot_tipo,lot_sup_vivienda 
					FROM 
					venta
				...
				for($i=0;$i<$num;$i++)
				{
					...
					?>
						<tr>
							...
							<td><?php echo $objeto->ven_meses_plazo; $spla+=$objeto->ven_meses_plazo; ?></td>

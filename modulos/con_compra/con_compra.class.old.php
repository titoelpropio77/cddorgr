...
//                return;
        ...
        $sql_ins_det="insert into con_compra_detalle(
                        ...
                        dcom_unegocios,dcom_pagos,dcom_com_tipo,dcom_nit,dcom_aut,dcom_control,dcom_nro_fac,dcom_poliza,
...
//                $excento=$obj->excento*1;
            ...
            $sql_ins_values=$sql_ins_det."(
                ...
                '$str_unegocios','$str_pagos','$obj->com_tipo','$obj->nit','$obj->aut','$obj->control','$obj->nro_fac','$obj->poliza',
            ...
            if($obj->tipo_nota=='factura'){
                 $sql = "insert into con_libro (
                                    ...
                                    '$obj->com_tipo','$dfecha', '$obj->nit', '$obj->aut', '$obj->control', '$obj->nro_fact',

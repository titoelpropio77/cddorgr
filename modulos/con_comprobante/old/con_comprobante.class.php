...
class con_comprobante extends BUSQUEDA {
    ...
    function CON_COMPROBANTE() {
        ...
        $this->arreglo_campos[7]["valores"] = "venta_pago,cv_divisa,reserva_pago,comision,venta,con_traspaso,con_compra,reserva_anulacion,venta_retencion,extra_pago,venta_cambio_lote,venta_devolucion,reserva_devolucion,pago_vendedores:Venta Pago,C/V Divisa,Reserva Pago,Comision,Venta,Traspaso,Compra,Reserva Anulacion,Venta Retencion,Pago Extra,Venta Cambio Lote,Venta Devolucion,Reserva Devolucion,Pago Vendedores";

...
class rep_pagos_venta_anu extends BUSQUEDA {

    var $formulario;
    var $mensaje;

    function rep_pagos_venta_anu() {
        //permisos
        $this->ele_id = 206;
        $this->busqueda();
        //fin permisos
        ...
        $this->modulo = 'rep_pagos_venta_anu';
        $this->formulario = new FORMULARIO();
        $this->formulario->set_titulo('ANULACION DE CUOTAS');
    ...
    function obtener_resultados() {
        ...
        if ($_POST['inicio'] <> "") {
            $filtro.=" and vpag_fecha_anu>= '" . FUNCIONES::get_fecha_mysql($_POST['inicio']) . "' ";
            $info[]=array('label'=>'Fecha Inicio','valor'=> $_POST['inicio']);
        } 
        if ($_POST['fin'] <> "") {
            $filtro.=" and vpag_fecha_anu <='" . FUNCIONES::get_fecha_mysql($_POST['fin']) . "' ";
        ...
        $sql = "SELECT 
                    ...
                    vpag_fecha_pago,vpag_dias_interes,ven_moneda,
                    vpag_capital,vpag_form,vpag_interes,vpag_envio,vpag_monto,vpag_usu_cre,vpag_recibo,suc_nombre,
                    vpag_saldo_final,ven_ubicacion,ven_multinivel,ven_numero,vpag_fecha_anu,vpag_usu_anu,vpag_observacion_anu,ven_concepto
                FROM 
                    venta_pago
                ...
                where vpag_monto>0 and vpag_estado='Anulado' $filtro
...
//        $estados_carteras=$_POST[estados_carteras];
        $head=array('#','Nro Venta','Cliente','Proyecto','Lote','Ubicacion',
                    ...
                    'Usu Anu','Fecha Anu.','Hora Anu.','Motivo Anu.'
                    );
...
//            vpag_fecha_anu,vpag_usu_anu,vpag_observacion_anu
//            'Usu Anu','Fecha Anu.','Hora Anu.','Hora Anu','Motivo Anu.'
            $afa = explode(' ', $obj->vpag_fecha_anu);
            $fecha_anu=  FUNCIONES::get_fecha_latina($afa[0]);
            $result[]=array(
                $nro,$obj->ven_id,$cliente,$obj->urb_nombre_corto,$obj->ven_concepto,$obj->ven_ubicacion,
                ...
                $obj->vpag_usu_anu,$fecha_anu,$afa[1],$obj->vpag_observacion_anu
            );
            $nro++;
            $conec->siguiente();
        }
...
//                    );
        ...
        $data=array(
            ...
            'foot'=>array(
                        ...
                        array(
                                array('texto'=>'Convertido a $us.','attr'=>'colspan="13"'),

...
//			   var cuenta_a=document.frm_vendedor.id_cuenta_a.value;			   
                                            ...
                                            <div id="ContenedorDiv">
                                                   ...
                                                   <div id="CajaInput">
                                                        <?php if($personas<>0) { ?>
                                                                ...
                                                                <input name="vdo_nombre_persona" id="vdo_nombre_persona" <?php if($ver || $cargar){ ?> readonly="readonly" disabled="disabled" <?php } ?>  type="text" class="caja_texto" value="<?php echo $_POST['vdo_nombre_persona']?>" size="35">
                                                                <?php if(!($ver || $cargar)){ ?>
                                                ...
                                                <div id="ContenedorDiv">
                                                   <div class="Etiqueta" ><span class="flechas1">* </span>Tio de Vendedor</div>
                                                   <div id="CajaInput">
		...
		var options1 = {
			...
			json:true,
			callback: function (obj) {
				document.getElementById('vdo_int_id').value = obj.id;
			}
		};
		var as_json1 = new _bsn.AutoSuggest('vdo_nombre_persona', options1);
		</script>
        <?php } ?>
        ...
        function listar_pagos_comisiones() {
                ...
                <script>
                    function anular_pago_comision(id) {
                        var txt = 'ï¿½Estï¿½ seguro de querer anular el pago de la comisiï¿½n?';
            ...
            <?php if(count($listado)>0){?>
                ...
                <script>
                    ...
                    function eliminar_comision(id){
                        var txt = 'ï¿½Estï¿½ seguro de querer anular el la Comision Asignada?';
                        $.prompt(txt, {
                            buttons: {Aceptar: true, Cancelar: false},
                            callback: function(v, m, f) {
                                if (v) {

...
class CON_REP_ESTADO_RESULTADO extends BUSQUEDA {

    var $formulario;
    var $mensaje;

    function CON_REP_ESTADO_RESULTADO() {
        $this->coneccion = new ADO();
        $this->link = 'gestor.php';
        $this->modulo = 'con_rep_estado_resultado';
        $this->formulario = new FORMULARIO();
        $this->formulario->set_titulo('ESTADO DE RESULTADOS');
    }
                        ...
                        <table style="font-size:12px;" width="100%" cellpadding="5" cellspacing="0" >                            
                            <tr>
                                ...
                                <td width="20%">
                                    <p align="center" >
                            <center>
                                <strong><h3>ESTADO DE RESULTADOS</h3></strong></br>
                                <?php

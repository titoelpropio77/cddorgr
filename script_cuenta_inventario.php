...
switch ($_GET[tarea]) {
    case "determinar_nro_venta_lote":
        echo "determinar_nro_venta_lote<br>";
        determinar_nro_venta_lote();
        break;
    
    case "actualizar_cuenta_inventario":
        echo "actualizar_cuenta_inventario<br>";
        actualizar_cuenta_inventario();
        break;
    
    case "actualizar_cuenta_inventario_cambio_lote":
        echo "actualizar_cuenta_inventario_cambio_lote<br>";
        actualizar_cuenta_inventario_cambio_lote();
        break;

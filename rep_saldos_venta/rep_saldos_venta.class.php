...
//            $filtro.=" and vpag_fecha_pago <='" . FUNCIONES::get_fecha_mysql($_POST['flimite']) . "' ";
        ...
        $sql = "SELECT 
                    ...
                    sum(vpag_capital_inc ) as incremento,sum(vpag_capital_desc ) as descuento,
                    sum(vpag_interes) as interes_pagado, sum(vpag_capital) as capital_pagado, count(*) as cuotas_pagadas, 
...
//            $saldo_capital=$obj->ven_usaldo ;//$saldo_financiar-$pagado->capital-$pagado->descuento+$pagado->incremento;
            ...
            $total->{"interes_pagado_$mon"}+=$obj->interes_pagado;
            $total->{"capital_pagado_$mon"}+=$obj->capital_pagado;
...
//                            ,'Saldo','U. Fecha Pag.','U. Fecha Valor');
            $result[]=array(
                $nro,$obj->ven_id,$cliente,"$obj->int_telefono/$obj->int_celular",$obj->int_direccion,$obj->urb_nombre_corto,$str_moneda,$des_lotes,$obj->ven_estado,$fecha,
        ...
        $data=array(
            ...
            'foot'=>array(
                        array(
                                array('texto'=>'Total en Bs.','attr'=>'colspan="10"'),$total->superficie,'',$total->valor_1*1,
                        ...
                        array(
                                array('texto'=>'Total en $us.','attr'=>'colspan="10"'),0,'',$total->valor_2*1,
                        ...
                        array(
                                array('texto'=>'Convertido a Bs.','attr'=>'colspan="10"'),0,'',$total->valor_1+($total->valor_2*$tca),
                        ...
                        array(
                                array('texto'=>'Convertido a $us.','attr'=>'colspan="10"'),0,'',$total->valor_2+($total->valor_1/$tca),

...
$data->read("excel/complejo_la_quinta.xls");
...
function insertar_zona($zon_nombre,$zon_precio,$urbanizacion,$zon_color,$zon_cuota_inicial,$zon_moneda)
{
    ...
    $sql = "insert into zona(zon_nombre,zon_precio,zon_urb_id,zon_color,zon_cuota_inicial,zon_moneda) values('" . $zon_nombre . "','" . $zon_precio . "','" . $urbanizacion . "','" . $zon_color . "','" . $zon_cuota_inicial . "','" . $zon_moneda . "')";
...
function insertar_lote($lot_nro,$lot_estado,$lot_man_id,$lot_zon_id,$lot_superficie,$lot_uv_id,$lot_tipo)
{
    ...
    $sql = "insert into lote(lot_nro,lot_estado,lot_man_id,lot_zon_id,lot_superficie,lot_uv_id,lot_tipo) values('" . $lot_nro . "','" . $lot_estado . "','" . $lot_man_id . "','" . $lot_zon_id . "','" . $lot_superficie . "','" . $lot_uv_id . "','" . $lot_tipo . "')";

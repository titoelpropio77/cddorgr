<?php
	...
	$sql ="select int_id as id,CONCAT(int_nombre, ' ', int_apellido) as nombre , int_usu_id as usuario from interno
	 where CONCAT(int_nombre, ' ', int_apellido) like '%$input%' limit 15";

...
function generar_plan() { ?>
    ...
    <div style="font-size: 13px; text-align: left ">
        ...
        <?php         
//        if($fecha_ven!='9999-99-99' && !isset($_POST[origen])){
        if($fecha_ven!='9999-99-99'){
        ?>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="plan_pago_efectivo div_plan_pagos">
            ...
            <div id="ContenedorSeleccion" class="lista_planes" style="margin-bottom: 5px; width: 98%">
                <table class="tablaReporte" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    ?>
                    <?php $sql_det="select * from interno_deuda_pago where idp_estado='Activo' and idp_tipo not in('costo','costo_producto') $filtro order by idp_fecha asc";?>
                    <?php $total=0;?>
...
//                        from interno_deuda where ind_tabla='venta' and ind_tabla_id=$ven_id and ind_estado in('Pendiente','Pagado')
//                ";

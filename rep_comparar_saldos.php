...
function calcular_saldo_venta_comercial($venta, $fecha_limite = null) {
    ...
    if ($fecha_limite < $hoy) {
        ...
        AUX_REPORTE::cargar_historia_ventas($arr_ventas, $fecha_limite, $token_user, $_SESSION[id], true);
...
/*
 * NOTAS IMPORTANTES
-- COMPROBANTES DONDE SE ENCUENTRAN LOS SALDOS DE VENTAS Y COSTOS PROPORCIONADOS
-- POR ORANGE A GLENDA SOTO LOS CUALES SE ANULARAN Y SERAN REEMPLAZADOS POR LOS 
-- AJUSTES INDIVIDUALES POR VENTA => SELECT * FROM `con_comprobante` WHERE `cmp_id` in (198573,197614,1137)
-- OJO, EL CMP 1137 SOLAMENTE ANULAR LOS DETALLES QUE REFERENCIAN A LOS SALDOS.
*/